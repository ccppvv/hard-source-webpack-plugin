...
const AMDRequireArrayDependencySerial = serial.serial(
  'AMDRequireArrayDependency',
  {
    constructor: {
      freeze(_, dependency, extra, methods) {
        return {
          depsArray: methods.mapFreeze(
            'Dependency',
            null,
            dependency.depsArray,
            extra
          ),
          range: dependency.range
        };
...
const AMDRequireContextDependencySerial = serial.serial(
  ...
  constructor: {
    ...
    thaw(thawed, frozen, extra, methods) {
      return new AMDRequireDependency(
        !frozen.block
          ? extra.parent
          : methods.thaw('DependencyBlock', null, frozen.block, extra)
      );
    }
  },
...
const AMDRequireItemDependencySerial = serial.serial(
...
const CommonJsRequireContextDependencySerial = serial.serial(
...
const CommonJsRequireDependencySerial = serial.serial(
...
const ContextElementDependencySerial = serial.serial(
...
const CriticalDependencyWarningSerial = serial.serial(
...
const DelegatedExportsDependencySerial = serial.serial(
...
const DelegatedSourceDependencySerial = serial.serial(
...
const DllEntryDependencySerial = serial.serial('DllEntryDependency', {
  constructor: {
    freeze(_, dependency, extra, methods) {
      return {
        dependencies: methods.mapFreeze(
          'Dependency',
          null,
...
const HarmonyAcceptImportDependencySerial = serial.serial(
...
const HarmonyCompatibilityDependencySerial = serial.serial(
...
const HarmonyExportExpressionDependencySerial = serial.serial(
...
const HarmonyExportHeaderDependencySerial = serial.serial(
...
const HarmonyExportImportedSpecifierDependencySerial = serial.serial(
...
const HarmonyExportSpecifierDependencySerial = serial.serial(
...
const HarmonyImportSideEffectDependencySerial = serial.serial(
...
const HarmonyImportSpecifierDependencySerial = serial.serial(
  ...
  constructor: {
    ...
    thaw(thawed, frozen, extra, methods) {
      ...
      if (!extra.state.localModules[frozen.localModule.idx]) {
        extra.state.localModules[frozen.localModule.idx] = new LocalModule(
          extra.module,
          frozen.localModule.name,
          frozen.localModule.idx
        );
        extra.state.localModules[frozen.localModule.idx].used =
...
const ModuleHotAcceptDependencySerial = serial.serial(
...
const ModuleHotDeclineDependencySerial = serial.serial(
...
const RequireContextDependencySerial = serial.serial(
...
const RequireEnsureItemDependencySerial = serial.serial(
...
const RequireIncludeDependencySerial = serial.serial(
...
const RequireResolveContextDependencySerial = serial.serial(
...
const RequireResolveDependencySerial = serial.serial(
...
const RequireResolveHeaderDependencySerial = serial.serial(
...
const WebAssemblyImportDependencySerial = serial.serial(
...
exports.map.set(
  CommonJsRequireContextDependency,
  CommonJsRequireContextDependencySerial
);
...
exports.map.set(
  HarmonyAcceptImportDependency,
  HarmonyAcceptImportDependencySerial
);
...
exports.map.set(
  HarmonyImportSideEffectDependency,
  HarmonyImportSideEffectDependencySerial
);
...
exports.map.set(
  RequireResolveContextDependency,
  RequireResolveContextDependencySerial
);
...
exports.map.set(
  RequireResolveHeaderDependency,
  RequireResolveHeaderDependencySerial
);
